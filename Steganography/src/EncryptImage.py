...
from src.EncryptText import Encrypt
...
def encrypt_data_into_image():
    """Enctypts data into image"""

    enc = Encrypt(txt.get(1.0, "end-1c"))
...
close_button = Button(app, text="Continue", bg='white', fg='black', command=app.destroy)
close_button.place(x=300, y=500)
app.mainloop()